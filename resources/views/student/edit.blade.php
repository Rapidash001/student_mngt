                       ...
                       <div class="row card-body col-12">
                         <div class="form-group col-12">
                            <label
                               ...
                               <input type="text" class="form-control g-2" id="fname" name="fname" placeholder="Enter your Firstname" require value="">
                         </div>
                        ...
                        <div class="form-group col-6">
                          ...
                          <input type="number" class="form-control" id="zip" name="zip" placeholder="" value="">
                        </div>
                        @error('zip') <span class="text-danger">{{$message}}</span> @enderror

                        <div class="form-group col-6">
                          <label for="exampleInputPassword1">Age</label>
                          <input type="number" class="form-control" id="age" name="age" placeholder="" value="">
                        </div>
